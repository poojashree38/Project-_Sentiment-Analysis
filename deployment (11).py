...
Original file is located at
    https://colab.research.google.com/drive/1_gp2AipA9QcRTf9s89rIm3s5FU1uQgzg
"""
...
def main():
    st.title("Sentiment Classification of Reviews Deployment")
        ...
        if user_input.strip() == "":
            ...
            try:
                ...
                if prediction in sentiment_dict:
                    predicted_sentiment = sentiment_dict[prediction]
                    st.subheader("Predicted Sentiment:")
                    st.write(predicted_sentiment)
                else:
                    st.warning(f"Prediction {prediction} not recognized. Expected predictions: {list(sentiment_dict.keys())}")
